...
class Bird {
    constructor() {
        this.request = axios.create({
            ...
            headers: {
                'Device-id': '7a1c31e5-6974-4668-9af5-26196378d0a5',
                'Platform': 'ios',
                'App-Version': '3.0.5'
            }
        })
    ...
    setAccessToken(accessToken) {
        ...
        this.request.defaults.headers.common[
            'Authorization'
        ] = `Bird eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJBVVRIIiwidXNlcl9pZCI6IjRiMDdiYTQzLTNiYTctNDdhNC05ZTQxLTcxNTBmNzE4ZmQ1NCIsImRldmljZV9pZCI6IjdhMWMzMWU1LTY5NzQtNDY2OC05YWY1LTI2MTk2Mzc4ZDBhNSIsImV4cCI6MTU3MDE1OTk4N30.meF2neCbxG_qKo03Vc4zsnztfELqdXX1xZ6vA6esXcI`
